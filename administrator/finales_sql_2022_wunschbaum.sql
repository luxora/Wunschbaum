...
INSERT INTO `wunschliste` (`wunschnummer`, `gruppe`, `kind`, `age`, `wunsch`, `wunscherfueller`, `wunscherfuellen`) VALUES
	...
	('118', 'Wurzelkinder', 'Annesa, 9 J.', '', 'Kleidung fuer Puppe First Words-gestreift rosa', '', ''),
