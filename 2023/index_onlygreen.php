...
<?php include ("db.php");?>
<body>
<link href="/kkllk/css/index.css" type="text/css" rel="stylesheet"/>
<?php /*include ("header.php"); */?>
<body>
...
<h1 style=" text-align: center; font-size: 48px;">Wunschbaum Aktion der KUVB</h1>
<?php include ("kopfbereich_vor_wunsch_erfuellen.php"); ?>
<div class="container content" style="margin-left: 3%;">
<h4>Ich m&ouml;chte einen Wunsch erf&uuml;llen <br>(derzeit werden nur bereits erf&uuml;llte W&uuml;nsche unten angezeigt):</h4><br>
...
?>
<form method="post" action="index_onlygreen.php" name="wuenscheerfuellen"/>
...
<input name="wuenscheerfuellereintragen" placeholder="Rudolph The Red-Nose Reindeer"></p><input style="padding: 15px; padding-left: 90px; padding-right: 90px; " type="submit" value="Wunsch erfüllen"/> (<--- bitte eigenen Vor und Nachnamen im Feld oben eintragen und dann auf Wunsch erf&uuml;llen klicken):<br>
</form>
<br>
