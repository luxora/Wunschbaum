...
<h1 style="font-size: 48px;">Wunschbaum Aktion der XXX - als Erfüller wieder austragen</h1>
...
echo ("Sie werden von der Wunsch ID ".$wunschid." wieder ausgetragen...");
 $sqlu = "UPDATE wunschliste SET wunscherfueller='', wunscherfuellen='' WHERE wunschnummer=$wunschid";
...
<?php
 $sqlz = "SELECT  * FROM wunschliste  WHERE wunscherfuellen='JA' ORDER BY wunschnummer ASC";
$ergz = $db->query($sqlz);
